...
from APIs.TalpiotAPIs.AssessmentAPI.Database.api.docx_for_docm.enum.section import WD_SECTION
from APIs.TalpiotAPIs.AssessmentAPI.Database.api.docx_for_docm.enum.text import WD_BREAK
...
from APIs.TalpiotAPIs.AssessmentAPI.Database.api.docx_for_docm.package import Package
from APIs.TalpiotAPIs.AssessmentAPI.Database.api.docx_for_docm.parts.numbering import NumberingPart
from APIs.TalpiotAPIs.AssessmentAPI.Database.api.docx_for_docm.shared import lazyproperty
    ...
    *docx* is missing or ``None``, the built-in default document "template"
    ...
    def _open(docx):
        ...
        *docx* can be either a path to a ``.docx`` file (a string) or a
        ...
        if (document_part.content_type != CT.WML_DOCUMENT_MAIN) and (
