...
from bot_features.Other.Settings.DevPanelFeature.Logic.dev_panel_logic import DevPanelLogic
...
class DevPanelFeature(BotFeature):
    ...
    def main(self, session: Session):
        ...
        self.ui.summarize_and_close(session, [
            self.ui.create_text_list_view(session, 'פרטי עדכון אחרון:', DevPanelLogic.get_last_commit_information())
        ])
