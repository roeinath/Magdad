...
from bot_features.Other.Settings.AboutFeature.DBModels.contribution import Contribution
...
class AboutFeature(BotFeature):
    ...
    def main(self, session: Session):
        ...
        self.ui.summarize_and_close(session, [
            self.ui.create_text_list_view(session, "תודות:",[str(contrib) for contrib in
