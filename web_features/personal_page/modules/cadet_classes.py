...
from web_features.personal_page.modules.grades_from_moodle import *
from APIs.TalpiotAPIs.AssessmentAPI.tsyunomat.GetDataFromDB import *
from os import chdir
from os.path import abspath, dirname
from web_features.personal_page.permissions import is_user_have_permissions, is_user_captain
SIZE_EXTRA_SMALL = 'xs'
SIZE_SMALL = 'sm'
SIZE_MEDIUM = 'md'
SIZE_LARGE = 'lg'
