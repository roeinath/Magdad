...
"""
Run-related proxy objects for python-docx_for_docm, Run in particular.
"""
...
class Run(Parented):
    ...
    def add_break(self, break_type=WD_BREAK.LINE):
        ...
        `WD_BREAK.COLUMN` where `WD_BREAK` is imported from `docx_for_docm.enum.text`.
...
class Font(ElementProxy):
    ...
    def size(self):
        ...
        length units. The :class:`docx_for_docm.shared.Pt` class allows convenient
