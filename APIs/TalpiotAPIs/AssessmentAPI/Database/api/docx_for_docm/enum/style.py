...
class WD_BUILTIN_STYLE(XmlEnumeration):
    ...
    Example::
        ...
        from APIs.TalpiotAPIs.AssessmentAPI.Database.api.docx_for_docm.enum.style import WD_STYLE
...
class WD_STYLE_TYPE(XmlEnumeration):
    ...
    Example::
        ...
        from APIs.TalpiotAPIs.AssessmentAPI.Database.api.docx_for_docm. import Document
        from APIs.TalpiotAPIs.AssessmentAPI.Database.api.docx_for_docm.enum.style import WD_STYLE_TYPE
