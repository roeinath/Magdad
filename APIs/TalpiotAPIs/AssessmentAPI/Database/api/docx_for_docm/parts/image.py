...
from APIs.TalpiotAPIs.AssessmentAPI.Database.api.docx_for_docm.opc.part import Part
from APIs.TalpiotAPIs.AssessmentAPI.Database.api.docx_for_docm.shared import Emu, Inches
