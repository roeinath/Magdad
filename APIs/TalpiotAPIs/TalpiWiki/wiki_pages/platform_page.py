...
import datetime
from mongoengine import Document, EmailField, StringField, IntField, ReferenceField, LongField, BooleanField,\
...
class PlatformPage(BaseWikiPage):

    middle = ["summary", "rational", "goals", "logic_line", "recommendation", "feedback", "organizers"]
